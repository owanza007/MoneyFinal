...
public class Expens2 {
    ...
    public Expens2(double price, int dayExpense, String monthExpense, int yearExpense, String id, String notes, String category) {
        this.price = price;
        this.id = id;
    ...
    public Expens2(double price, String monthExpense, int yearExpense, String id) {
        this.price = price;
        this.id = id;
        this.monthExpense = monthExpense;
        this.yearExpense = yearExpense;
    ...
    public Expens2(String product, double price, int yearExpense, String id) {
        this.price = price;
        this.id = id;
        this.yearExpense = yearExpense;
    }
